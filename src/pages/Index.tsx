...
const DisplayH = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => (
  <h2
    className={`font-display-light text-5xl md:text-6xl lg:text-7xl leading-[1.02] text-foreground tracking-tight ${className}`}
  >
    {children}
  </h2>
);
...
const industries = [
  {
    ...
    title: "Oil & Gas",
    img: imgOilgas,
    copy: "Upstream, midstream and downstream operations across the GCC.",
  },
  {
    n: "02",
    title: "Petrochemical",
    img: imgPetro,
    copy: "Refining, processing and chemical handling infrastructure.",
  },
...
const services = [
  {
    ...
    copy: "Direct partnerships with tier-one OEMs deliver authentic equipment under transparent commercial terms.",
  },
  {
    n: "S/02",
    title: "Technical Advisory",
    copy: "Engineering-led specification, BOM optimization and lifecycle planning for mission-critical systems.",
  },
  {
    n: "S/03",
    title: "Logistics & Delivery",
    copy: "End-to-end freight, customs and on-site delivery across the GCC, MENA and beyond.",
  },
  {
    n: "S/04",
    title: "After-Sales Support",
    copy: "Spares continuity, warranty handling and field-service coordination over the asset lifecycle.",
  },
];
...
const expertise = [
  {
    n: "E/01",
    title: "Mechanical",
    copy: "Pumps, valves, compressors, heat exchangers and rotating equipment engineered for high-pressure service.",
  },
  {
    n: "E/02",
    title: "Instrumentation",
    copy: "Field instruments, control systems and safety detection that deliver plant-wide visibility.",
  },
  {
    n: "E/03",
    title: "Electrical",
    copy: "LV/MV switchgear, transformers, motors and drives — designed for continuous industrial duty.",
  },
  {
    n: "E/04",
    title: "Industrial Chemicals",
    copy: "Lubricants, drilling fluids and treatment chemicals supporting refineries and offshore operations.",
  },
  {
    n: "E/05",
    title: "Marine",
    copy: "Specialised supply for VLCs and VLCCs — pumps, valves and onboard systems for the harshest environments.",
  },
];
...
const products = [
  {
    ...
    img: imgMechanical,
    copy: "A wide array of mechanical components and systems designed to ensure optimal performance and reliability across high-pressure service environments.",
    items: [
      "Centrifugal & Positive Displacement Pumps",
      "Ball, Gate, Globe & Check Valves",
      "Compressors & Heat Exchangers",
      "Flanges, Fittings & Gaskets",
    ],
  },
  {
    n: "P/02",
    ...
    copy: "Precision instruments that provide accurate measurements and control for critical processes — engineered for plant-wide visibility and safety.",
    items: [
      "Pressure, Flow & Level Transmitters",
      "PLC, DCS & SCADA Systems",
      "Control Valves & Actuators",
      "Safety & Fire-Gas Detection",
    ],
  },
  {
    n: "P/03",
    ...
    img: imgElectrical,
    copy: "Advanced electrical systems and components that power and sustain operations across industries — from LV switchgear to MV distribution.",
    items: [
      "LV/MV Switchgear & Panels",
      "Transformers & Reactors",
      "Motors, Drives & Soft Starters",
      "Cables, Terminations & Accessories",
    ],
  },
  {
    n: "P/04",
    title: "Industrial Chemicals",
    img: imgChemicals,
    copy: "Industrial-grade chemicals that meet the highest standards of safety and efficiency, supporting refineries, pipelines and offshore operations.",
    items: [
      "Industrial Lubricants & Greases",
      "Drilling & Completion Fluids",
      "Corrosion & Scale Inhibitors",
      "Cleaning & Treatment Chemicals",
    ],
  },
  {
    n: "P/05",
    ...
    img: imgMarine,
    copy: "Trusted supplier of high-quality products for VLCs (Very Large Carriers) and VLCCs (Very Large Crude Carriers) — engineered for the harshest marine environments.",
    items: [
      "Marine-Grade Pumps & Valves",
      "Deck & Engine Room Equipment",
      "Onboard Safety & Fire Systems",
      "Spares for VLCs & VLCCs",
    ],
  },
];
...
const globePins: GlobePin[] = [
  ...
  { name: "Qatar", lat: 25.2854, lon: 51.531, flag: "🇶🇦" },
  ...
  { name: "Estonia", lat: 59.437, lon: 24.7536, flag: "🇪🇪" },
  { name: "S. Korea", lat: 37.5665, lon: 126.978, flag: "🇰🇷" },
        ...
        <div className="container">
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-7">
              <DisplayH>A trusted partner for the world&rsquo;s most demanding industries.</DisplayH>
            </div>
            <div className="lg:col-span-5 lg:pt-6 space-y-6 text-[15px] text-muted-foreground leading-[1.8] font-light">
              <p>
                As an established supplier in the energy sector, INDESS delivers top-quality equipment sourced from
                globally renowned manufacturers — meticulously chosen for performance, durability and efficiency.
              </p>
              <p>
                Our team of experienced engineers and supply professionals understands the critical role reliable
                equipment plays in upstream, midstream and downstream operations.
              </p>
            </div>
          </div>
          ...
          <div className="mt-24 grid grid-cols-2 md:grid-cols-4 border-t border-border">
            {[
              ...
              <div
                key={i}
                className={`py-10 ${i > 0 ? "md:border-l" : ""} ${i % 2 === 1 ? "border-l md:border-l" : ""} border-border`}
              >
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 lg:pl-12">
              ...
              <p className="font-display-light text-3xl md:text-4xl leading-[1.25] text-foreground mb-8">
                &ldquo;At INDESS we believe quality is not a feature — it is the foundation upon which every reliable
                operation is built.&rdquo;
              </p>
              <div className="space-y-5 text-[15px] text-muted-foreground leading-[1.8] font-light">
                <p>
                  We are delighted to welcome you to INDESS — your gateway to top-quality oil &amp; gas supply
                  equipment. Our commitment is simple: source globally, engineer trust locally, and stand behind every
                  shipment we deliver.
                </p>
                <p>
                  With a network of trusted manufacturers and a deeply experienced technical team, we propel our
                  clients&rsquo; operations to new heights with cutting-edge equipment and unrivalled expertise.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 mb-20">
            ...
            <Reveal delay={120} className="lg:col-span-5 lg:col-start-8 lg:pt-8">
              <p className="text-[15px] text-white/70 leading-[1.8] font-light">
                INDESS provides a comprehensive range of products tailored to the unique needs of our clients —
                engineered for performance, reliability and the highest standards of safety.
              </p>
            </Reveal>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10">
            ...
            <Reveal delay={expertise.length * 70} className="bg-[hsl(207_100%_25%)] p-10 flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-white/75 font-light leading-[1.7]">
                  Explore our complete product reference — categories, sub-categories and specifications.
                </p>
              </div>
              <Link
                to="/catalog"
                className="inline-flex items-center gap-2 mt-8 text-[11px] tracking-editorial uppercase text-white border-b border-gold pb-2 w-fit"
              >
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 lg:col-start-8 lg:pt-8">
              <p className="text-[15px] text-muted-foreground leading-[1.8] font-light">
                At INDESS Solutions Trading, we provide a comprehensive range of products tailored to the unique needs
                of our clients — engineered for performance, reliability and the highest standards of safety across five
                specialised domains.
              </p>
              <Link
                to="/catalog"
                className="inline-flex items-center gap-3 mt-8 text-[11px] tracking-editorial uppercase font-medium text-white bg-brand px-6 py-3 hover:bg-brand-deep transition-colors"
              >
              ...
              <Reveal key={p.n} className="container block" y={48}>
                ...
                >
                  ...
                  <div className="lg:col-span-5">
                    ...
                    <h3 className="font-display-light text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight mb-6">
                      {p.title}
                    </h3>
                    ...
                    <ul className="border-t border-border">
                      {p.items.map((it) => (
                        <li
                          key={it}
                          className="flex items-center justify-between py-4 border-b border-border text-[13px] text-foreground/80 font-light"
                        >
                          <span>{it}</span>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-5">
              <div className="bg-white border border-border p-12 lg:p-16 flex items-center justify-center aspect-[4/3]">
                <img
                  src={oasisLogo}
                  alt="OASIS — Occupational Health and Safety Integrated Services"
            ...
            <div className="lg:col-span-7">
              ...
              <DisplayH className="!text-4xl md:!text-5xl lg:!text-6xl">
                INDESS joins hands with <span className="italic font-light text-brand">Oasis</span> to deliver
                world-class HSE services & trainings.
              </DisplayH>
              <p className="mt-8 text-[15px] text-muted-foreground leading-[1.8] font-light max-w-2xl">
                M/s OASIS — Occupational Health and Safety Integrated Services — is a reputable, multi-disciplinary
                company specialising in HSE Trainings, Human Resource solutions, Consultancy and Trading services for
                national and international clients across diverse industries.
              </p>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 mt-10 text-[11px] tracking-editorial uppercase font-medium text-white bg-brand px-6 py-3 hover:bg-brand-deep transition-colors"
              >
        ...
        <div className="container">
          <div className="grid lg:grid-cols-12 gap-12 mb-20">
            ...
            <div className="lg:col-span-6 lg:col-start-7 lg:pt-8">
              <p className="text-[15px] text-muted-foreground leading-[1.8] font-light">
                Our portfolio supports six core industries where reliability, safety and uptime are non-negotiable. Each
                engagement is engineered to the standards of the sector it serves.
              </p>
            </div>
          </div>
      ...
      <section id="brands" className="py-32 lg:py-40 bg-brand-soft">
        <div className="container">
          <div className="grid lg:grid-cols-12 gap-12 mb-20">
            ...
            <div className="lg:col-span-5 lg:col-start-8 lg:pt-8">
              <p className="text-[15px] text-muted-foreground leading-[1.8] font-light">
                We represent and supply equipment from a curated portfolio of global OEMs, selected for engineering
                excellence and proven field reliability.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 border-t border-l border-border bg-white">
            {brands.map((b, i) => (
              <div
                key={b.name}
                className="border-r border-b border-border aspect-[3/2] flex items-center justify-center group hover:bg-brand-soft transition-colors p-6"
              >
                <div className="text-center flex flex-col items-center gap-2">
                  {b.logo ? (
                    <img src={b.logo} alt={b.name} className="max-h-12 w-auto object-contain" />
                  ) : (
                    <div className="font-display-light text-2xl md:text-3xl text-foreground/85 group-hover:text-brand transition-colors">
                      {b.name}
                    </div>
                  )}
      ...
      <section id="partners" className="py-32 lg:py-40 bg-white">
        <div className="container">
          <div className="grid lg:grid-cols-12 gap-12 mb-16">
            ...
            <div className="lg:col-span-5 lg:col-start-8 lg:pt-8">
              <p className="text-[15px] text-muted-foreground leading-[1.8] font-light">
                A curated network of manufacturers across Asia and Europe — each chosen for engineering excellence,
                certification rigour and proven field reliability.
              </p>
              <Link
                to="/partners"
                className="inline-flex items-center gap-3 mt-8 text-[11px] tracking-editorial uppercase font-medium text-white bg-brand px-6 py-3 hover:bg-brand-deep transition-colors"
              ...
              <Reveal key={p.name} delay={i * 80}>
                ...
                >
                  <div className="flex items-center justify-between mb-8">
                    <span className="text-[11px] tracking-editorial uppercase text-gold">
                  ...
                  <h3 className="font-display-light text-2xl md:text-[1.65rem] mb-4 leading-tight group-hover:text-brand transition-colors">
                    {p.name}
                  </h3>
          ...
          <div className="mt-24 pt-16 border-t border-border">
            <div className="flex flex-wrap items-end justify-between gap-6 mb-8">
              ...
              <Link
                to="/clients"
                className="inline-flex items-center gap-2 text-[11px] tracking-editorial uppercase text-foreground/70 hover:text-brand transition-colors"
              >
            ...
            <div className="flex flex-wrap gap-x-10 gap-y-5">
              {clients.map((c) => (
                <span
                  key={c}
                  className="font-display-light text-2xl md:text-3xl text-foreground/55 hover:text-brand transition-colors"
                >
                  {c}
                </span>
              ))}
            ...
            <div className="grid lg:grid-cols-12 gap-12 mb-16">
              ...
              <div className="lg:col-span-5 lg:col-start-8 lg:pt-8">
                <p className="text-[15px] text-white/65 leading-[1.8] font-light">
                  From the GCC to Europe, the Americas and Asia Pacific — INDESS operates across eleven countries,
                  supporting clients with sourcing, logistics and after-sales presence wherever their projects demand.
                </p>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-7">
              ...
              <p className="text-[15px] text-white/65 leading-[1.8] font-light max-w-xl mb-12">
                Share your specifications and our engineering team will respond within one business day with a tailored
                quotation, technical consultation or our complete product catalog.
              </p>
              <div className="flex flex-wrap gap-4 mb-16">
                <a
                  href="mailto:sales@indessuae.com?subject=Request%20a%20Quote"
                  className="group inline-flex items-center gap-3 text-[11px] tracking-editorial uppercase font-medium text-foreground bg-gold px-8 py-4 hover:bg-white transition-colors"
                >
                  Request a Quote
                  <ArrowUpRight
                    size={16}
                ...
                <a
                  href="tel:+97126711663"
                  className="inline-flex items-center gap-3 text-[11px] tracking-editorial uppercase font-medium text-white border border-white/30 px-8 py-4 hover:bg-white/10 transition-colors"
                >
                  Call Our Team
                </a>
              </div>
              ...
              <div className="grid sm:grid-cols-3 gap-8 text-sm pt-10 border-t border-white/10">
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/85 font-light leading-relaxed text-[13px]">
                ...
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:sales@indessuae.com" className="text-white/85 hover:text-gold font-light">
                      sales@indessuae.com
                    </a>
                  </div>
                </div>
              ...
              <div className="border border-white/15 bg-white/[0.03] p-8 lg:p-10">
                ...
                <form onSubmit={submit} className="space-y-7">
                  {[
                    ...
                    <div key={f.k}>
                      <label className="block text-[10px] tracking-editorial uppercase text-white/50 mb-3">
                        {f.label}
                      </label>
                      <input
                        required
