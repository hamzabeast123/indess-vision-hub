    ...
    <footer className="bg-[hsl(210_100%_8%)] text-white/70">
      <div className="container py-20 grid lg:grid-cols-12 gap-10">
        <div className="lg:col-span-4 space-y-6">
          ...
          <Link to="/#contact" className="inline-flex items-center gap-2 text-[11px] tracking-editorial uppercase text-white bg-brand px-5 py-3 hover:bg-brand-deep transition-colors">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <ul className="space-y-3 text-sm text-white/65 font-light">
            <li>
              <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:text-gold transition-colors">
                <Linkedin size={15} /> LinkedIn
              </a>
            </li>
            <li>
              <a href="https://www.facebook.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:text-gold transition-colors">
